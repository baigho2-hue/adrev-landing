            ...
            switch (samplingType)
            {
                ...
                case SamplingType.Quota:
                    return isQualitative 
                        ...
                        : "Un échantillonnage par quotas sera utilisé pour respecter des proportions prédéfinies dans l'échantillon.";
                
                case SamplingType.Theoretical:
                    return "Un échantillonnage théorique (Theoretical sampling) sera utilisé : l'échantillon évoluera au fur et à mesure de l'analyse pour affiner les catégories émergentes.";

                case SamplingType.Purposeful:
                    return "Un échantillonnage intentionnel (Purposeful sampling) sera utilisé, sélectionnant des participants possédant des caractéristiques directement liées à la question de recherche.";

                case SamplingType.PurposefulTypical:
                    return "Un échantillonnage intentionnel de type « cas typique » sera utilisé pour décrire une situation considérée comme représentative ou ordinaire.";

                case SamplingType.PurposefulExtreme:
                    return "Un échantillonnage intentionnel de « cas extrêmes ou déviants » sera utilisé pour comprendre des phénomènes inhabituels ou rares.";

                case SamplingType.PurposefulCritical:
                    return "Un échantillonnage intentionnel de « cas critiques » sera utilisé, car l'étude de ces cas spécifiques peut éclairer un phénomène plus large.";

                case SamplingType.PurposefulHomogeneous:
                    return "Un échantillonnage intentionnel homogène sera utilisé pour explorer en profondeur un groupe ayant des caractéristiques similaires.";

                case SamplingType.PurposefulHeterogeneous:
                    return "Un échantillonnage intentionnel hétérogène (variation maximale) sera privilégié pour explorer la complexité et la diversité du phénomène.";

                case SamplingType.CaseStudy:
                    return "Un échantillonnage raisonné par cas multiples sera utilisé pour approfondir la compréhension du phénomène à travers plusieurs situations.";

                case SamplingType.CaseStudyContrasted:
                    return "Une sélection de cas contrastés sera opérée pour comparer et mettre en évidence les différences structurelles du phénomène.";

                case SamplingType.CaseStudySimilar:
                    return "Une sélection de cas similaires sera effectuée pour valider et approfondir les régularités observées.";

                case SamplingType.CaseStudyCritical:
                    return "Une sélection de cas critiques sera réalisée pour tester les limites de la théorie en construction.";

                case SamplingType.CaseStudyExemplary:
                    return "Une sélection de cas exemplaires ou « best practices » sera utilisée pour illustrer les réussites ou les modèles du domaine.";

                case SamplingType.EventContextual:
                    return "Un échantillonnage événementiel ou contextuel sera privilégié, ciblant des moments ou des lieux spécifiques où le phénomène est le plus observable.";
